...
(function (global) {
  ...
  const DICT = {
    he: {
      ...
      moveDone: 'האימון הועבר ✓', moveOccupied: 'כבר יש אימון ביום הזה',
      gcalTitle: 'סנכרון ל-Google Calendar', gcalHint: 'דחפו את אימוני היומן ל-Google Calendar (6 שבועות קדימה) — כל אימון עם תזכורת מייל ופופאפ אוטומטית מ-Google.',
      gcalClientLabel: 'Google OAuth Client ID', gcalSyncBtn: '📅 סנכרן אימונים ליומן',
      gcalNote: 'בפעם הראשונה Google יבקש אישור חד-פעמי. התזכורות נשלחות ע״י Google Calendar עצמו.',
      gcalEventTitle: 'אימון: {name}', gcalNeedId: 'הזינו קודם Google Client ID',
      gcalNoWorkouts: 'אין אימונים מתוכננים לסנכרון', gcalSyncing: 'מסנכרן…',
      gcalDone: 'סונכרנו {n} אימונים ליומן Google ✓', gcalErr: 'הסנכרון נכשל — בדקו את ה-Client ID וההרשאות',
      gcalConnected: '✅ מחובר ל-Google Calendar', gcalChange: 'שנה מזהה',
      ...
      accountTitle: 'החשבון שלי — גיבוי וסנכרון',
      accountHint: 'התחברו כדי לשמור את כל הנתונים בענן ולסנכרן בין הטלפון, הטאבלט והמחשב. בלי התחברות — הכול נשמר במכשיר הזה בלבד.',
      signInGoogle: 'התחברות עם Google',
      orSep: 'או',
      emailPh: 'האימייל שלך',
      signInEmail: 'שלחו לי קישור התחברות',
      signedInAs: 'מחובר/ת כ־',
      signOut: 'התנתקות',
      syncOn: 'סנכרון פעיל ✓',
      checkEmail: 'שלחנו לך קישור התחברות למייל 📧 (בדקו גם בתיקיית הספאם)',
      emailBad: 'הכניסו כתובת אימייל תקינה',
      emailErr: 'שליחת המייל נכשלה. נסו שוב.',
      emailRate: 'נשלחו יותר מדי בקשות. המתינו כמה דקות ונסו שוב.',
      googleErr: 'התחברות Google עדיין לא מופעלת בשרת. הפעילו את ספק Google ב-Supabase.',
      cloudOffline: 'שירות הענן אינו זמין כרגע (בדקו חיבור לאינטרנט).',
      cloudNote: 'הנתונים שלך מוצפנים בהעברה ונגישים רק לך. מפתח ה-AI האישי נשאר במכשיר ואינו נשמר בענן.',
      ...
      aiQuota: 'הגעת למכסת ה-AI היומית ({used}/{limit}). נסו שוב מחר, או הזינו מפתח אישי בהגדרות ⚙️',
      aiLoginNeeded: 'כדי להשתמש ב-AI המשותף יש להתחבר (טאב "אני"), או להזין מפתח אישי בהגדרות ⚙️',
      aiQuotaLeft: 'נותרו {n} בקשות AI היום',
    ...
    en: {
      ...
      moveDone: 'Workout moved ✓', moveOccupied: 'That day already has a workout',
      gcalTitle: 'Sync to Google Calendar', gcalHint: 'Push your scheduled workouts to Google Calendar (next 6 weeks) — each with an automatic email + popup reminder from Google.',
      gcalClientLabel: 'Google OAuth Client ID', gcalSyncBtn: '📅 Sync workouts to calendar',
      gcalNote: 'Google asks for a one-time approval on first use. Reminders are sent by Google Calendar itself.',
      gcalEventTitle: 'Workout: {name}', gcalNeedId: 'Enter a Google Client ID first',
      gcalNoWorkouts: 'No scheduled workouts to sync', gcalSyncing: 'Syncing…',
      gcalDone: 'Synced {n} workouts to Google Calendar ✓', gcalErr: 'Sync failed — check the Client ID and permissions',
      gcalConnected: '✅ Connected to Google Calendar', gcalChange: 'Change ID',
      ...
      accountTitle: 'My account — backup & sync',
      accountHint: 'Sign in to save everything to the cloud and sync across your phone, tablet and computer. Without signing in, all data stays on this device only.',
      ...
      signOut: 'Sign out',
      syncOn: 'Sync active ✓',
      checkEmail: 'We emailed you a sign-in link 📧 (check your spam folder too)',
      emailBad: 'Enter a valid email address',
      emailErr: 'Sending the email failed. Try again.',
      emailRate: 'Too many requests. Please wait a few minutes and try again.',
      googleErr: 'Google sign-in is not enabled on the server yet. Enable the Google provider in Supabase.',
      cloudOffline: 'The cloud service is unavailable right now (check your internet connection).',
      cloudNote: 'Your data is encrypted in transit and accessible only to you. Your personal AI key stays on the device and is never stored in the cloud.',
      ...
      aiQuota: "You've hit today's AI limit ({used}/{limit}). Try again tomorrow, or add your own key in settings ⚙️",
      aiLoginNeeded: 'To use the shared AI please sign in (the "Me" tab), or add your own key in settings ⚙️',
      aiQuotaLeft: '{n} AI requests left today',
