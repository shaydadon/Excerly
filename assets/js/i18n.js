...
(function (global) {
  ...
  const DICT = {
    he: {
      ...
      photoClearAria: 'הסר תמונה ותוצאה',
      ...
      srcTzameret: '🇮🇱 נתונים ממאגר התזונה הלאומי (משרד הבריאות)',
      srcMixed: '🇮🇱 חלק מהנתונים ממאגר משרד הבריאות, השאר הערכת AI',
      srcItemDb: 'מאגר משהב״ר', srcItemEst: 'הערכת AI',
    ...
    en: {
      ...
      photoClearAria: 'Remove photo & result',
      ...
      srcTzameret: '🇮🇱 Data from the Israeli National Nutrition Database (MOH)',
      srcMixed: '🇮🇱 Some data from the MOH database, the rest AI-estimated',
      srcItemDb: 'MOH DB', srcItemEst: 'AI estimate',
